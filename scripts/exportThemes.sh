...
rm -rf ${DIR}/../keycloak/themes/keycloak-provided-themes

# Create the directory for the themes
mkdir -p ${DIR}/../keycloak/themes/keycloak-provided-themes
...
docker cp ${CONTAINER_ID}:/opt/keycloak/lib/lib/main/${JAR_FILE} ${DIR}/../keycloak/themes/keycloak-provided-themes